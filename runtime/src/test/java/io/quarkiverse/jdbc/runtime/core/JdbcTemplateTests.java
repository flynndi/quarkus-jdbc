...
import io.quarkiverse.jdbc.runtime.core.support.AbstractInterruptibleBatchPreparedStatementSetter;
import io.quarkiverse.jdbc.runtime.datasource.ConnectionProxy;
import io.quarkiverse.jdbc.runtime.support.GeneratedKeyHolder;
import io.quarkiverse.jdbc.runtime.support.KeyHolder;
import io.quarkiverse.jdbc.runtime.support.SQLErrorCodeSQLExceptionTranslator;
...
class JdbcTemplateTests {
	...
	@Test
	@Disabled("Depends on Spring SingleConnectionDataSource/SmartDataSource, which is not part of the Quarkus-native runtime")
	void leaveConnectionOpenOnRequest() throws Exception {
		...
		DataSource scf = mock();
		given(scf.getConnection()).willReturn(this.connection);
