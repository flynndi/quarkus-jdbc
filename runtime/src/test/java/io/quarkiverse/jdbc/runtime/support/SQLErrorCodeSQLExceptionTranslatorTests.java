...
class SQLErrorCodeSQLExceptionTranslatorTests {
	...
	void errorCodeTranslation() {
		...
		checkTranslation(8, io.quarkiverse.jdbc.runtime.exception.DeadlockLoserDataAccessException.class);
		checkTranslation(9, io.quarkiverse.jdbc.runtime.exception.CannotSerializeTransactionException.class);
