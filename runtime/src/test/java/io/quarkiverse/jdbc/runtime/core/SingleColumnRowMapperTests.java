...
class SingleColumnRowMapperTests {
	...
	@Test  // SPR-16483
	void useDefaultConversionService() throws SQLException {
	...
	@Test  // SPR-16483
	void useCustomConversionService() throws SQLException {
		Timestamp timestamp = new Timestamp(0);

		ConversionService myConversionService = new ConversionService() {
			@Override
			public boolean canConvert(Class<?> sourceType, Class<?> targetType) {
				return (Timestamp.class == sourceType && MyLocalDateTime.class == targetType);
			}

			@Override
			public <T> T convert(Object source, Class<T> targetType) {
				return targetType.cast(new MyLocalDateTime(((Timestamp) source).toLocalDateTime()));
			}
		};
	...
	@Test // SPR-16483
	void doesNotUseConversionService() throws SQLException {
