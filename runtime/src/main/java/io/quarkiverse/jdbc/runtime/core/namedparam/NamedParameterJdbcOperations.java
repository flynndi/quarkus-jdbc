...
import io.quarkiverse.jdbc.runtime.core.PreparedStatementCallback;
 ...
 * {@link io.quarkiverse.jdbc.runtime.core.JdbcOperations} interface,
 ...
 * @see io.quarkiverse.jdbc.runtime.core.JdbcOperations
 */
public interface NamedParameterJdbcOperations {
	 ...
	 * JDBC environment: that is, participating in managed transactions
	 * and converting JDBC SQLExceptions into the DataAccessException hierarchy.
	 ...
	 * @throws io.quarkiverse.jdbc.runtime.exception.IncorrectResultSizeDataAccessException
	 ...
	 * @throws io.quarkiverse.jdbc.runtime.exception.IncorrectResultSizeDataAccessException
	 * if the query does not return exactly one row
	 * @throws io.quarkiverse.jdbc.runtime.exception.IncorrectResultSetColumnCountException
	 * if the query does not return a row containing a single column
	 * @throws DataAccessException if the query fails
	 * @see io.quarkiverse.jdbc.runtime.core.JdbcTemplate#queryForObject(String, Class)
	 * @see io.quarkiverse.jdbc.runtime.core.SingleColumnRowMapper
	 */
	 ...
	 * if the query does not return exactly one row
	 * @throws DataAccessException if the query fails
	 * @see io.quarkiverse.jdbc.runtime.core.JdbcTemplate#queryForMap(String)
	 * @see io.quarkiverse.jdbc.runtime.core.ColumnMapRowMapper
	 */
	 ...
	 * @throws DataAccessException if the query fails
	 * @see io.quarkiverse.jdbc.runtime.core.JdbcTemplate#queryForList(String, Class)
	 * @see io.quarkiverse.jdbc.runtime.core.SingleColumnRowMapper
	 */
	 ...
	 * @throws DataAccessException if the query fails
	 * @see io.quarkiverse.jdbc.runtime.core.JdbcTemplate#queryForList(String)
	 */
	 ...
	 * @see io.quarkiverse.jdbc.runtime.core.JdbcTemplate#queryForRowSet(String)
	 * @see io.quarkiverse.jdbc.runtime.core.SqlRowSetResultSetExtractor
	 ...
	 * @see io.quarkiverse.jdbc.runtime.support.GeneratedKeyHolder
