 ...
 * @see JdbcTemplate
 * @see io.quarkiverse.jdbc.runtime.core.namedparam.NamedParameterJdbcOperations
 */
public interface JdbcOperations {
	 ...
	 * data access operations, within the managed JDBC environment:
	 * that is, participating in managed transactions and converting
	 * JDBC SQLExceptions into the DataAccessException hierarchy.
	 ...
	 * converting JDBC SQLExceptions into the DataAccessException hierarchy.
	 * <p>The callback action can return a result object, for example a domain
	 * object or a collection of domain objects.
