...
import io.quarkiverse.jdbc.runtime.core.BatchPreparedStatementSetter;
import io.quarkiverse.jdbc.runtime.core.ColumnMapRowMapper;
...
import io.quarkiverse.jdbc.runtime.core.PreparedStatementCreator;
import io.quarkiverse.jdbc.runtime.core.PreparedStatementCreatorFactory;
...
import io.quarkiverse.jdbc.runtime.core.SingleColumnRowMapper;
import io.quarkiverse.jdbc.runtime.core.SqlParameter;
import io.quarkiverse.jdbc.runtime.core.SqlRowSetResultSetExtractor;
...
import io.quarkiverse.jdbc.runtime.util.ConcurrentLruCache;
 ...
 * The underlying {@link io.quarkiverse.jdbc.runtime.core.JdbcTemplate} is
 * exposed to allow for convenient access to the traditional
 * {@link io.quarkiverse.jdbc.runtime.core.JdbcTemplate} methods.
 *
 ...
 * @see RowMapper
 * @see io.quarkiverse.jdbc.runtime.core.JdbcTemplate
 */
public class NamedParameterJdbcTemplate implements NamedParameterJdbcOperations {
	 ...
	 * <p>Creates a classic {@link io.quarkiverse.jdbc.runtime.core.JdbcTemplate} and wraps it.
	 ...
	 * Spring {@link io.quarkiverse.jdbc.runtime.core.JdbcTemplate}.
	 * @param classicJdbcTemplate the classic JdbcTemplate to wrap
	 */
	...
	/**
	 * Expose the classic JdbcTemplate operations to allow invocation
	...
	/**
	 * Expose the classic {@link JdbcTemplate} itself, if available,
