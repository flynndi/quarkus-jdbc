...
import io.quarkiverse.jdbc.runtime.support.MetaDataAccessException;
...
public final class TableMetaDataProviderFactory {
	...
	private static final Logger logger = Logger.getLogger(TableMetaDataProviderFactory.class);
