 ...
 * @see io.quarkiverse.jdbc.runtime.core.simple.JdbcClient.StatementSpec#paramSource(Object)
 * @see io.quarkiverse.jdbc.runtime.core.SimplePropertyRowMapper
 */
public class SimplePropertySqlParameterSource extends AbstractSqlParameterSource {
    ...
    public @Nullable Object getValue(String paramName) throws IllegalArgumentException {
        ...
        if (desc instanceof Method method) {
            ...
            return ReflectionUtils.invokeMethod(method, this.paramObject);
        }
    ...
    public int getSqlType(String paramName) {
        ...
        Object desc = getDescriptor(paramName);
        if (desc instanceof Method method) {
            return StatementCreatorUtils.javaTypeToSqlParameterType(method.getReturnType());
        }
        else if (desc instanceof Field field) {
