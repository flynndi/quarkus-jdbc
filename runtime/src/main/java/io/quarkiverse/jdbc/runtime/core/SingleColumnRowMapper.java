...
import io.quarkiverse.jdbc.runtime.exception.IncorrectResultSetColumnCountException;
...
public class SingleColumnRowMapper<T> implements RowMapper<@Nullable T> {
	 ...
	 * @see io.quarkiverse.jdbc.runtime.support.JdbcUtils#getResultSetValue(java.sql.ResultSet, int, Class)
	 ...
	 * @return the Object value
	 * @throws SQLException in case of extraction failure
	 * @see io.quarkiverse.jdbc.runtime.support.JdbcUtils#getResultSetValue(java.sql.ResultSet, int)
	 */
