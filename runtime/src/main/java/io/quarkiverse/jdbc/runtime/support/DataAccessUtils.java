...
import io.quarkiverse.jdbc.runtime.exception.EmptyResultDataAccessException;
import io.quarkiverse.jdbc.runtime.exception.IncorrectResultSizeDataAccessException;
...
public abstract class DataAccessUtils {
    ...
    public static <T> T objectResult(@Nullable Collection<?> results, @Nullable Class<T> requiredType)
        ...
        if (requiredType != null && !requiredType.isInstance(result)) {
            if (String.class == requiredType) {
                ...
                try {
                    result = convertNumberToTargetClass(number, (Class<? extends Number>) requiredType);
                }
    ...
    public static RuntimeException translateIfNecessary(
        ...
        if (pet == null) {
            throw new IllegalArgumentException("PersistenceExceptionTranslator must not be null");
        }
    ...
    private static boolean hasUniqueObject(Collection<?> collection) {
    ...
    private static Number convertNumberToTargetClass(Number number, Class<? extends Number> targetClass) {
