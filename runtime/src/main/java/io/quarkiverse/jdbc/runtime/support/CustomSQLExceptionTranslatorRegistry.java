...
public final class CustomSQLExceptionTranslatorRegistry {
	...
	private static final Logger logger = Logger.getLogger(CustomSQLExceptionTranslatorRegistry.class);
	 ...
	 * {@link io.quarkiverse.jdbc.runtime.support.SQLErrorCodesFactory}.
	 */
