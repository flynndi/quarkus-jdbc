...
import io.quarkiverse.jdbc.runtime.support.rowset.ResultSetWrappingSqlRowSet;
import io.quarkiverse.jdbc.runtime.support.rowset.SqlRowSet;

/**
 * {@link ResultSetExtractor} implementation that returns a {@link SqlRowSet}
 ...
 * @since 1.2
 * @see #newCachedRowSet
 * @see io.quarkiverse.jdbc.runtime.support.rowset.SqlRowSet
...
public class SqlRowSetResultSetExtractor implements ResultSetExtractor<SqlRowSet> {
	 ...
	 * <p>This implementation creates a {@link ResultSetWrappingSqlRowSet}
	 ...
	 * @see #newCachedRowSet()
	 * @see io.quarkiverse.jdbc.runtime.support.rowset.ResultSetWrappingSqlRowSet
	 */
