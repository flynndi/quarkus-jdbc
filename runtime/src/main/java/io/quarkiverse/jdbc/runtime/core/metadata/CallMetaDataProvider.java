 ...
 * {@link io.quarkiverse.jdbc.runtime.core.simple.SimpleJdbcCall}.
 *
...
public interface CallMetaDataProvider {
	 ...
	 * @throws SQLException in case of initialization failure
	 * @see	io.quarkiverse.jdbc.runtime.core.simple.SimpleJdbcCall#withoutProcedureColumnMetaDataAccess()
	 */
